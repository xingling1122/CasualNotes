 ...
 */
public class LoginENFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LanguageUtils.ChangeLanguage(getContext(),LanguageUtils.ENGLISH);
    ...
    class FragmentAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position == 0) {
                ...
                fragment.setCurrent_language(LanguageUtils.ENGLISH);
    ...
    private LoginFragment.ForgotPswListener forgotPswListener;

    public void setForgotPswListener(LoginFragment.ForgotPswListener forgotPswListener){
