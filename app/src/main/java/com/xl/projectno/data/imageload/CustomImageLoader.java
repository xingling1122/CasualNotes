...
public class CustomImageLoader {
	 ...
	 * @param isMemoryCahce if true,cache to memory
	 * @param isDiskCache  if true,cache to disk
	 */
	public ImageContainer get(String requestUrl, final ImageListener listener,
			boolean isMemoryCahce, boolean isDiskCache) {
		return get(requestUrl, listener, 0, 0, isMemoryCahce, isDiskCache);
	}
	...
	public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth,
			int maxHeight, final boolean isMemoryCache, boolean isDiskCache) {
		...
		Request<?> newRequest = new ImageRequest(requestUrl, new Listener<Bitmap>() {
			...
			public void onResponse(Bitmap response) {
				onGetImageSuccess(cacheKey, response, isMemoryCache);
			}
		...
		newRequest.setShouldCache(isDiskCache);
	 ...
	 */
	private void onGetImageSuccess(String cacheKey, Bitmap response, boolean isMemoryCache) {
